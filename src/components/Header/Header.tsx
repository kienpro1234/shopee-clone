          ...
          {isAuthenticated && (
            ...
            >
              <div className="mr-2 h-5 w-5 flex-shrink-0">
                <img
                  src="https://images.viblo.asia/f1f7004c-cd83-4a78-8d99-27f0247e872a.png"
                  alt=""
        ...
        <div className="mt-4 grid grid-cols-12 items-center gap-4">
              ...
              <div className="relative max-w-[400px] rounded-sm border border-gray-200 bg-white text-sm shadow-md">
                {purchaseIncart ? (
                  <div className="">
                    ...
                    <div className="mt-5">
                      {purchaseIncart.slice(0, MAX_PRODUCT_RENDER).map((purchase) => (
                        <div className="mt-2 flex items-center p-2 hover:bg-gray-100" key={purchase._id}>
                    ...
                    <div className="mt-6 flex items-center justify-between p-2">
                      <div className="text-xs capitalize text-gray-500">
                        {purchaseIncart.length > MAX_PRODUCT_RENDER ? purchaseIncart.length - MAX_PRODUCT_RENDER : ""}
                        Thêm vào giỏ hàng
                      </div>
                      <button className="hover:bg-opcity-90 rounded-sm bg-orange px-4 py-2 capitalize text-white">
                        Xem giỏ hàng
                      </button>
                    </div>
                  </div>
                  ...
                  <div className="flex h-[250px] w-[400px] flex-col items-center justify-center p-2">
                    <img src={noproductImg} className="size-20" alt="no product" />
                    <span>Không có hàng trong giỏ hàng</span>
                  </div>
                )}
              </div>
            }
          >
            <Link to={"/cart"} className="relative">
              ...
              <span className="absolute -right-1 -top-1 flex size-3 items-center justify-center rounded-full bg-white p-1 text-[9px] text-orange">
